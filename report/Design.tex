...
%are we comfortable in saying most :p
...
the comparison being true, false, or we have one of each. 
%I dont completely get what you mean here with "with of each
%If the node only have 1 child, how can we have one of each. The explination comes afterwards, but when this
%line is read, it can be confusing.
\input{treeNoName2}
