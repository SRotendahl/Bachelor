...
%We could show this list kinda like figure 7, but I 
...
\input{treeNoName2}
In Figure \textbf{Only the bottom of the trees}\ref{treeNoName2} we have an example of the first case. Here we take the first
...
there are multiple children that depend on the comparison result, as in \textbf{Only the bottom of the trees}\ref{treeNoName2}. In this case we need to combine the threshold value
